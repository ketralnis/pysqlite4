#-*- coding: ISO-8859-1 -*-
# pysqlite4/test/__init__.py: the package containing the test suite
#
...
from pysqlite4.test import dbapi, types, userfunctions, factory, transactions,\
...
def suite():
    ...
    if sys.version_info >= (2, 5, 0):
        from pysqlite4.test.py25 import py25tests
